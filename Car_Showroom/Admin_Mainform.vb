...
Public Class Admin_Mainform
    ...
    Private Sub Admin_Mainform_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'CarWashDataSetre.Customer' table. You can move, or remove it, as needed.
        Me.CustomerTableAdapter3.Fill(Me.CarWashDataSetre.Customer)
        'TODO: This line of code loads data into the 'CarWashDataSetre.OrderHistory' table. You can move, or remove it, as needed.
        Me.OrderHistoryTableAdapter3.Fill(Me.CarWashDataSetre.OrderHistory)
        'TODO: This line of code loads data into the 'CarWashDataSetre.InventoryStatus' table. You can move, or remove it, as needed.
        Me.InventoryStatusTableAdapter3.Fill(Me.CarWashDataSetre.InventoryStatus)
